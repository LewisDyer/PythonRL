    ...
    while not libtcod.console_is_window_closed():
        ...
        for player_turn_result in player_turn_results:
            ...
            if xp:
                ...
                if leveled_up:
                    message_log.add_message(Message('Your battle skills have grown stronger!'
                                                    'You reach level {0}!'.format(player.level.current_level),
                                                    libtcod.yellow))
                    previous_game_state = game_state
...
def main():
    ...
    libtcod.console_set_custom_font('consolas12x12_gs_tc.png', libtcod.FONT_TYPE_GRAYSCALE | libtcod.FONT_LAYOUT_TCOD)
